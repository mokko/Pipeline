<xsl:stylesheet version="2.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
	...
	<!-- 
		...
		rpx stands RIA MPX stands for my xml export from new version of MuseumPlus
		principles: 
		-no sonderzeichen: Zetcom doesn't allow sonderzeichen in element names, so 
		"masse" instead of "maße"
		-we use small camel capitalization for elements, leaving out spaces, periods etc.
