...
def test_identNr(xml_fn):
    ...
    r = tree.xpath(
        "/n:shf/n:sammlungsobjekt[not(n:identNr)]",
...
def test_hersteller(source_xml, dest_xml):
    ...
    s = stree.xpath(
        "/m:museumPlusExport/m:sammlungsobjekt/m:personenKörperschaften[@funktion = 'Hersteller']",
        namespaces={"m": "http://www.mpx.org/mpx"},
    )
    d = dtree.xpath(
        "/n:shf/n:sammlungsobjekt/n:hersteller",
        namespaces={"n": "http://www.mpx.org/npx"},
    )
    if not len(s) == len(d):
...
def test_künstler(source_xml, dest_xml):
    ...
    s = stree.xpath(
        "/m:museumPlusExport/m:sammlungsobjekt/m:personenKörperschaften[@funktion = 'Künstler' or @funktion = 'Objektkünstler']",
        namespaces={"m": "http://www.mpx.org/mpx"},
    )
    d = dtree.xpath(
        "/n:shf/n:sammlungsobjekt/n:künstler",
        namespaces={"n": "http://www.mpx.org/npx"},
    )
